...
function initVertexBuffers(gl) {
    var verticesColors = new Float32Array([
        0.75,   1.0,    -4.0,   0.4,    1.0,    0.4,        //右侧绿色三角形，最后
        0.25,   -1.0,   -4.0,   0.4,    1.0,    0.4,
        1.25,   -1.0,   -4.0,   1.0,    0.4,    0.4,

        0.75,   1.0,    -2.0,   1.0,    1.0,    0.4,        //右侧黄色三角形，中间
        0.25,   -1.0,   -2.0,   1.0,    1.0,    0.4,
        1.25,   -1.0,   -2.0,   1.0,    0.4,    0.4,

        0.75,   1.0,    0.0,   0.4,    0.4,    1.0,         //右侧蓝色三角形，前面
        0.25,   -1.0,   0.0,   0.4,    0.4,    1.0,
        1.25,   -1.0,   0.0,   1.0,    0.4,    0.4,

        -0.75,   1.0,    -4.0,   0.4,    1.0,    0.4,        //左侧绿色三角形，最后
        -1.25,   -1.0,   -4.0,   0.4,    1.0,    0.4,
        -0.25,   -1.0,   -4.0,   1.0,    0.4,    0.4,

        -0.75,   1.0,    -2.0,   1.0,    1.0,    0.4,        //左侧黄色三角形，中间
        -1.25,   -1.0,   -2.0,   1.0,    1.0,    0.4,
        -0.25,   -1.0,   -2.0,   1.0,    0.4,    0.4,

        -0.75,   1.0,    0.0,   0.4,    0.4,    1.0,         //左侧蓝色三角形，前面
